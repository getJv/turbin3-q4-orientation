...
var Turbin3_wallet_json_1 = require("./Turbin3-wallet.json");
var Turbin3_prereq_1 = require("./programs/Turbin3_prereq");
var keypair = web3_js_1.Keypair.fromSecretKey(new Uint8Array(Turbin3_wallet_json_1.default));
var connection = new web3_js_1.Connection("https://api.devnet.solana.com");
var github = Buffer.from("getjv", "utf8");
